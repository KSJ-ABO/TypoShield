...
```
sudo git clone https://github.com/KSJ-ABO/TypoShield.git
```
```
sudo apt install pip && pip install pymysql && pip install bc && pip install python3 
```
```
sudo chmod +x ./tss.sh
```
```
sudo ./tss.sh [-c] [-p] [파이썬 코드파일 경로/다운받으려는 패키지명]
```
